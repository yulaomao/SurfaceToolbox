...
vtkCjyxDynamicModelerSelectByPointsTool::vtkCjyxDynamicModelerSelectByPointsTool()
{
  ...
  inputModelEvents->InsertNextValue(vtkDMMLModelNode::MeshModifiedEvent);
  inputModelEvents->InsertNextValue(vtkDMMLTransformableNode::TransformModifiedEvent);
  ...
  inputFiducialListEvents->InsertNextValue(vtkDMMLMarkupsNode::PointModifiedEvent);
  inputFiducialListEvents->InsertNextValue(vtkDMMLTransformableNode::TransformModifiedEvent);
  vtkNew<vtkStringArray> inputFiducialListClassNames;
  inputFiducialListClassNames->InsertNextValue("vtkDMMLMarkupsFiducialNode");
...
//----------------------------------------------------------------------------
bool vtkCjyxDynamicModelerSelectByPointsTool::RunInternal(vtkDMMLDynamicModelerNode* surfaceEditorNode)
{
  ...
  vtkDMMLModelNode* outputSelectionScalarsModelNode = vtkDMMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(SELECT_BY_POINTS_OUTPUT_MODEL_WITH_SELECT_BY_POINTS_SCALARS_REFERENCE_ROLE));
  vtkDMMLModelNode* outputSelectedFacesModelNode = vtkDMMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(SELECT_BY_POINTS_OUTPUT_MODEL_WITH_SELECTED_FACES_REFERENCE_ROLE));
  ...
  vtkDMMLNode* inputNode = surfaceEditorNode->GetNodeReference(SELECT_BY_POINTS_INPUT_FIDUCIAL_LIST_REFERENCE_ROLE);
  vtkDMMLMarkupsFiducialNode* fiducialNode = vtkDMMLMarkupsFiducialNode::SafeDownCast(inputNode);
  if (!fiducialNode)
    {
  ...
  vtkDMMLModelNode* inputModelNode = vtkDMMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(SELECT_BY_POINTS_INPUT_MODEL_REFERENCE_ROLE));
  if (!inputModelNode)
    {
  ...
  if (computeSelectionScalarsModel)
    ...
    outputSelectionScalarsModelNode->InvokeCustomModifiedEvent(vtkDMMLModelNode::MeshModifiedEvent);
    }
  ...
  if (computeSelectedFacesModel)
    ...
    DMMLNodeModifyBlocker blocker(outputSelectedFacesModelNode);
    outputSelectedFacesModelNode->SetAndObserveMesh(this->SelectedFacesOutputMesh);
    outputSelectedFacesModelNode->InvokeCustomModifiedEvent(vtkDMMLModelNode::MeshModifiedEvent);
    }
...
//----------------------------------------------------------------------------
void vtkCjyxDynamicModelerSelectByPointsTool::CreateOutputDisplayNodes(vtkDMMLDynamicModelerNode* surfaceEditorNode)
{
  ...
  if (outputSelectionScalarsModelNode && !outputSelectionScalarsModelNode->GetModelDisplayNode())
    ...
    vtkDMMLModelDisplayNode* outputDisplayNode = outputSelectionScalarsModelNode->GetModelDisplayNode();
    outputDisplayNode->SetActiveScalar(SELECTION_ARRAY_NAME, vtkAssignAttribute::POINT_DATA);
    outputDisplayNode->SetAndObserveColorNodeID("vtkDMMLColorTableNodeFileViridis.txt");
  ...
  if (inputModelNode && outputSelectedFacesModelNode && !outputSelectedFacesModelNode->GetModelDisplayNode())
    ...
    vtkDMMLModelDisplayNode* outputDisplayNode = outputSelectedFacesModelNode->GetModelDisplayNode();
    vtkDMMLModelDisplayNode* inputDisplayNode = inputModelNode->GetModelDisplayNode();
    outputDisplayNode->SetColor(inputDisplayNode->GetColor());
    }
}

//----------------------------------------------------------------------------
bool vtkCjyxDynamicModelerSelectByPointsTool::UpdateUsingSphereRadius(vtkPolyData* inputMesh_World, vtkDMMLMarkupsFiducialNode* fiducialNode,
...
//----------------------------------------------------------------------------
bool vtkCjyxDynamicModelerSelectByPointsTool::UpdateUsingGeodesicDistance(vtkPolyData* inputMesh_World, vtkDMMLMarkupsFiducialNode* fiducialNode,
