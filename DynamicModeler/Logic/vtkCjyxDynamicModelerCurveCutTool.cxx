...
vtkCjyxDynamicModelerCurveCutTool::vtkCjyxDynamicModelerCurveCutTool()
{
  ...
  inputCurveEvents->InsertNextTuple1(vtkDMMLMarkupsNode::PointModifiedEvent);
  inputCurveEvents->InsertNextTuple1(vtkDMMLTransformableNode::TransformModifiedEvent);
  vtkNew<vtkStringArray> inputCurveClassNames;
  inputCurveClassNames->InsertNextValue("vtkDMMLMarkupsCurveNode");
  NodeInfo inputCurve(
    "Curve",
  ...
  insidePointListClassNames->InsertNextValue("vtkDMMLMarkupsFiducialNode");
...
//----------------------------------------------------------------------------
bool vtkCjyxDynamicModelerCurveCutTool::RunInternal(vtkDMMLDynamicModelerNode* surfaceEditorNode)
{
  ...
  vtkDMMLModelNode* outputInsideModelNode = vtkDMMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(CURVE_CUT_OUTPUT_INSIDE_MODEL_REFERENCE_ROLE));
  vtkDMMLModelNode* outputOutsideModelNode = vtkDMMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(CURVE_CUT_OUTPUT_OUTSIDE_MODEL_REFERENCE_ROLE));
  ...
  vtkDMMLModelNode* inputModelNode = vtkDMMLModelNode::SafeDownCast(surfaceEditorNode->GetNodeReference(CURVE_CUT_INPUT_MODEL_REFERENCE_ROLE));
  ...
  vtkDMMLNode* inputNode = surfaceEditorNode->GetNodeReference(CURVE_CUT_INPUT_CURVE_REFERENCE_ROLE);
  ...
  vtkDMMLMarkupsFiducialNode* insidePointNode = vtkDMMLMarkupsFiducialNode::SafeDownCast(
