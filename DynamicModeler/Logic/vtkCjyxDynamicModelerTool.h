...
public:
  ...
  /// The number of vtkDMMLNode that can be used as input for this tool.
  ...
  /// The number of vtkDMMLNode that can be used as output for this tool.
  ...
  vtkDMMLNode* GetNthInputNode(int n, vtkDMMLDynamicModelerNode* surfaceEditorNode);
  ...
  vtkDMMLNode* GetNthOutputNode(int n, vtkDMMLDynamicModelerNode* surfaceEditorNode);
  ...
  vtkVariant GetNthInputParameterValue(int n, vtkDMMLDynamicModelerNode* surfaceEditorNode);
  ...
  virtual bool HasRequiredInputs(vtkDMMLDynamicModelerNode* surfaceEditorNode);

  /// Returns true if all of the required inputs have been specified for the surface editor node.
  virtual bool HasOutput(vtkDMMLDynamicModelerNode* surfaceEditorNode);

  /// Get a list of all input nodes from the tool node
  virtual void GetInputNodes(vtkDMMLDynamicModelerNode* surfaceEditorNode, std::vector<vtkDMMLNode*>& inputNodes);

  /// Get a list of all output nodes from the tool node
  virtual void GetOutputNodes(vtkDMMLDynamicModelerNode* surfaceEditorNode, std::vector<vtkDMMLNode*>& outputNodes);
  ...
  /// in the input.
  virtual void CreateOutputDisplayNodes(vtkDMMLDynamicModelerNode* surfaceEditorNode);

  /// Run the surface editor tool.
  /// Checks to ensure that all of the required inputs have been set.
  bool Run(vtkDMMLDynamicModelerNode* surfaceEditorNode);
...
protected:
  ...
  virtual bool RunInternal(vtkDMMLDynamicModelerNode* surfaceEditorNode) = 0;
